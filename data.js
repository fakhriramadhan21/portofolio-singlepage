const portfolioData = {
  ...
  "experience": [
    ...
    },
    {
      ...
      "description": "Developed sustainability-related products including 'Spryx'. Collaborated on projects with Intel Corp and created community-based applications like 'Repair Kopitiam'. Focusing on creating innovative solutions for sustainability challenges."
    },
    {
      ...
      "description": "Managed Bebassampah.id, an environmental education platform. Maintained VPS servers and several WordPress-based websites. Directed the development of the GFDP philanthropy application."
    },
    {
  ...
  "education": [
    {
      ...
      "details": "GPA: 3.33/4.00. Head of Technopreneur Research Laboratory (2019). Practicum Assistant for Mobile Apps Development and Lecturer Assistant for Capstone Project."
    }
  ],
  "projects": [
    {
    ...
    },
    {
      "id": 114,
      "name": "BISYA",
      "description": "An Android-based application for learning sign language (alphabet, numbers, words, and sentences) equipped with interactive quiz features.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=BISYA+App",
      "url": "https://play.google.com/store/apps/details?id=com.frankyindustries.fakhri.bisya",
      "tags": ["Android", "Education"]
    },
    {
      "id": 115,
      "name": "Pertamax Otopreneur",
      "description": "Collaboration project with a Jakarta-based IT Solution company and PT. Pertamina. Built the Admin Website and Microapps API to connect vehicle services with customers.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=Pertamax+Otopreneur",
      "url": "https://play.google.com/store/apps/details?id=com.otopreneur.otopreneur_customer",
      "tags": ["API", "Web Admin", "IT Solution"]
    },
    {
      "id": 116,
      "name": "Batik Ganasan",
      "description": "E-commerce website and business profile for UMKM Batik in Subang. Features CRM integration and SEO optimization to boost online sales.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=Batik+Ganasan",
      "url": "https://batikganasan.id/home",
      "tags": ["E-commerce", "SEO", "CRM"]
    },
    {
      "id": 117,
      "name": "Batik Kembang Turi",
      "description": "Business website for UMKM Batik Kota Blitar focusing on customer data storage via CRM and improved search visibility through SEO techniques.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=Batik+Kembang+Turi",
      "url": "http://batikkembangturi.id/",
      "tags": ["Web", "SEO", "CRM"]
    },
    {
      "id": 118,
      "name": "POS Restaurant (Barokah Lestari)",
      "description": "Web-based Point of Sales application for restaurant management. Features include direct table ordering, automated income tracking, and sales analysis.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=POS+Restoran",
      "url": "https://www.barokahlestari.shop/login",
      "tags": ["POS", "Web Application", "Management"]
    },
    {
      "id": 119,
      "name": "Lintas Bandung",
      "description": "Public transportation route information application for Bandung City (Thesis Project). Includes routes, pricing, estimated time, and digital payment integration.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=Lintas+Bandung",
      "url": "https://lintasbandung.nyoobie.com/",
      "tags": ["Android", "API", "Thesis Project"]
    },
    {
      "id": 120,
      "name": "Robot Browser",
      "description": "Ultra-lightweight Android web browser (1.5 Mb), ad-free, prioritizing user data security with auto-delete history features.",
      "image": "https://dummyimage.com/600x400/2d3748/edf2f7&text=Robot+Browser",
      "url": "bit.ly/RobotBrowser",
